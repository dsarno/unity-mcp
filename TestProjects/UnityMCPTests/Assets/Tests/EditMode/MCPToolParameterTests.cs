    ...
    public class MCPToolParameterTests
    {
		...
		public void Test_ManageAsset_JSONStringParsing_TextureAssignment_CreateAndModify()
		{
			...
			try
			{
				...
				Assert.IsNotNull(tex, "Test texture should exist (generated by editor script)");
		...
		public void Test_EndToEnd_PropertyHandling_AllScenarios()
		{
			...
			try
			{
				...
				Assert.AreEqual(Color.red, mat.GetColor("_Color"), "Test 1: Material should have red color");
				...
				Assert.AreEqual(new Color(0, 0.5f, 1, 1), mat.GetColor("_Color"), "Test 2: Color should be cyan");
